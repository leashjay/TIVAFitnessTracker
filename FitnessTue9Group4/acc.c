...
/*********************************************************
 * initAccl
 * Direct copy from Lab3: initAccl.c
 *********************************************************/
void
initAccl (void)
{
 ...
 * Direct copy from Lab3: readAcc3.c
 ********************************************************/
vector3_t
getAcclData (void)
{
    ...
    I2CGenTransmit(fromAccl, bytesToRead, READ, ACCL_ADDR); //Data to write, Quantity, R/W, Add of device
